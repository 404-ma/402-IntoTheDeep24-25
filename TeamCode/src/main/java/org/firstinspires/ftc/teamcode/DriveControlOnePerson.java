...
public class DriveControlOnePerson extends LinearOpMode {
    ...
    private void update_telemetry(GamePad gpi1) {
        ...
        telemetry.addLine().addData("Left Trigger", "%6.3f", gamepad1.left_trigger);
        telemetry.addLine().addData("Right Trigger", "%6.3f", gamepad1.right_trigger);
        telemetry.addLine().addData("Viper Motor Power: ", viperMotor.getPower());
        telemetry.addLine().addData("Viper Motor Current Position: ", viperMotor.getCurrentPosition());
        telemetry.addLine().addData("Viper Motor Target Position: ",viperMotor.getTargetPosition());
        telemetry.addLine().addData("Viper Position Difference: ", (viperMotor.getTargetPosition() - viperMotor.getCurrentPosition()));
        telemetry.update();
    }
}
